...
export default function UrlEncoderClient() {
  ...
  const handleProcess = () => {
    ...
    try {
      ...
      setError(`Failed to ${mode}. Ensure your input is a valid URL component.`);
      setOutput("");
    }
  };
  ...
  const copyToClipboard = () => {
    ...
    setCopied(true);
    toast.success("URL manifest copied!");
    setTimeout(() => setCopied(false), 2000);
  };

  return (
    <ToolLayout 
      title="URL Entity Transcoder" 
      description="Professional URI serialization engine. Transcode special characters into web-safe entities or deserialize encoded strings into readable manifests."
      fullWidth={true}
    >
        ...
        <div className="w-full lg:sticky lg:top-28 space-y-8 animate-in fade-in slide-in-from-left-8 duration-700">
            ...
            <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-[2.5rem] sm:rounded-[3.5rem] p-6 sm:p-10 space-y-10 shadow-xl relative overflow-hidden">
               ...
               <div className="space-y-8 relative z-10">
                  <div className="flex bg-zinc-50 dark:bg-zinc-800/80 p-2 rounded-[2rem] shadow-inner-soft border border-zinc-100 dark:border-zinc-800">
                    ...
                    >
                      <Globe className="w-4 h-4" /> DECODE
                    </button>
                  </div>
                  ...
                  <div className="flex items-center gap-4 p-5 rounded-2xl bg-[#c5a059]/5 border border-[#c5a059]/10">
                     ...
                     <p className="text-[10px] font-black uppercase tracking-[0.1em] text-muted-foreground leading-relaxed italic">
                        localized component serialization. RFC 3986 compliant.
                     </p>
                  </div>
               </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#c5a059]/10 to-white dark:from-[#c5a059]/5 dark:to-zinc-900 p-10 shadow-xl rounded-[2.5rem] sm:rounded-[3.5rem] space-y-10 relative overflow-hidden group border border-[#c5a059]/20">
               ...
               <div className="flex items-center gap-4 mb-4 relative z-10">
                  ...
                  <div>
                    <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-[#c5a059] italic leading-none">Global Logic</h4>
               ...
               <div className="space-y-4 relative z-10">
                  {[
                    { icon: Code, label: "URI Encoding", detail: "Active" },
                    { icon: Terminal, label: "Entity Matrix", detail: "Enabled" },
                    { icon: ShieldCheck, label: "Secure Bridge", detail: "Verified" }
                  ].map((item, i) => (
               ...
               <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-12">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-zinc-50 dark:bg-zinc-800/50 rounded-[2.5rem] p-1 border border-zinc-100 dark:border-zinc-800 shadow-inner-soft relative overflow-hidden group/input">
                        ...
                        <div className="absolute top-4 right-8 z-20">
                           <span className="text-[9px] font-mono font-black text-zinc-400/40 uppercase tracking-widest">{mode === 'encode' ? 'RAW_URI' : 'ENCODED_URI'}</span>
                        </div>
                        <textarea
                          ...
                          placeholder={mode === "encode" ? "Initialize raw URI manifest..." : "Initialize encoded URI block..."}
                          value={input}
                  ...
                  <div className="space-y-6">
                    <div className="flex justify-between items-center px-4">
                       ...
                       {output && (
                          <span className="text-[10px] font-mono font-black text-[#c5a059]/40">{output.length} Chars</span>
                       )}
                    </div>
                    <div className={cn(
                       ...
                       error ? "border-red-500/20" : "border-[#c5a059]/20"
                        ...
                        <div className="absolute top-4 right-8 z-20">
                           <span className="text-[9px] font-mono font-black text-[#c5a059]/40 uppercase tracking-widest">{mode === 'encode' ? 'SERIALIZED_URI' : 'DESERIALIZED_URI'}</span>
                        </div>
                        <textarea
                          readOnly
                          className={cn(
