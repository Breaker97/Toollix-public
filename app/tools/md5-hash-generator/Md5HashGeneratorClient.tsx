...
export default function Md5HashGeneratorClient() {
  ...
  const handleProcess = () => {
    ...
    const hash = CryptoJS.MD5(input + salt).toString();
  ...
  return (
    <ToolLayout 
      title="MD5 Cryptographic Hash" 
      description="Professional checksum and fingerprinting tool. Generate secure MD5 hashes with optional salting for data integrity verification."
      fullWidth
    >
            ...
            <div className="suite-card rounded-[2.5rem] p-8 space-y-6 overflow-hidden relative">
              <div className="flex items-center justify-between border-b border-zinc-100 dark:border-zinc-800 pb-6">
                <div className="flex items-center gap-3">
                   ...
                   <h3 className="text-[11px] font-black uppercase tracking-[0.2em] text-slate-400 dark:text-zinc-500 italic">Source Data</h3>
                </div>
                <Button 
                   variant="ghost" 
                   size="icon" 
              ...
              <div className="space-y-6">
                 <div className="space-y-4">
                    ...
                    <textarea
                      className="w-full h-[150px] bg-zinc-50/50 dark:bg-zinc-800/30 rounded-2xl p-6 border border-zinc-100 dark:border-zinc-800 resize-none focus:outline-none font-mono text-[14px] text-zinc-800 dark:text-zinc-200 caret-[#c5a059]"
                 ...
                 <div className="space-y-4">
                    <div className="flex justify-between items-center px-2">
                       <label className="text-[10px] font-black uppercase tracking-widest text-[#c5a059]">MD5 Hash Output</label>
                       <Button variant="ghost" size="icon" onClick={copyToClipboard} className="h-6 w-6 text-[#c5a059] hover:bg-[#c5a059]/10">
                          {copied ? <CheckCircle2 className="w-3.5 h-3.5" /> : <Copy className="w-3.5 h-3.5" />}
                       </Button>
                    </div>
                    <div className="w-full bg-[#c5a059]/5 dark:bg-[#c5a059]/10 rounded-2xl p-6 border border-[#c5a059]/20 font-mono text-[16px] text-[#c5a059] break-all">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
               <Button 
                ...
                >
                  ...
                  {copied ? "COPIED TO CLIPBOARD" : "COPY HASH RESULT"}
                </Button>
                <div className="flex items-center gap-4 px-8 h-20 rounded-[2rem] bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800">
                   <div className="flex flex-col text-center">
                      <span className="text-[9px] font-black uppercase tracking-widest text-slate-400">Entropy</span>
          ...
          <div className="lg:col-span-4 space-y-6 lg:sticky lg:top-24">
            ...
            <div className="suite-card rounded-[2.5rem] p-8 space-y-8 animate-in slide-in-from-right-4 duration-500">
               <div className="space-y-1">
                  <h2 className="text-xl font-bold text-slate-900 dark:text-white tracking-tight">Hash Settings</h2>
                  <p className="text-[10px] font-bold text-slate-400 dark:text-zinc-500 uppercase tracking-widest italic">Security Protocol</p>
               </div>

               <div className="space-y-6">
                  <div className="space-y-3">
                     <label className="text-[10px] font-black uppercase tracking-widest text-slate-400">Salt (Optional)</label>
                     <input 
                        type="text"
                  ...
                  <div className="space-y-4 pt-4 border-t border-zinc-100 dark:border-zinc-800">
                     <div className="flex items-center justify-between p-4 bg-zinc-50 dark:bg-zinc-800 rounded-2xl border border-zinc-100 dark:border-zinc-700">
                        <div className="flex items-center gap-3">
                           ...
                           <span className="text-[10px] font-black uppercase tracking-widest text-slate-600 dark:text-zinc-300">UPPERCASE HASH</span>
                        </div>
                        <input 
                           type="checkbox" 
                           checked={upperCase} 
            ...
            <div className="suite-card p-8 rounded-[2.5rem] bg-[#c5a059]/5 border border-[#c5a059]/10 space-y-4">
               <div className="flex items-center gap-3">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-widest text-[#c5a059]">Local Encryption</span>
               </div>
               <p className="text-[10px] font-medium text-slate-500 leading-relaxed uppercase tracking-wider italic">
                  MD5 is computed locally. Your input strings and secret salts never touch our servers.
               </p>
            </div>
          </div>
        </div>
