...
export default function RemoveExtraSpacesClient() {
  ...
  const handleProcess = () => {
    ...
    if (options.lineBreaks) {
      ...
      // Re-run multi-space if line breaks added new ones
      result = result.replace(/ +/g, " ");
    }
  ...
  return (
    <ToolLayout 
      title="Text Space Purifier" 
      description="Clean up messy documents by removing duplicate spaces, tabs, and unnecessary line breaks. Professional-grade text normalization."
      fullWidth
    >
            ...
            <div className="suite-card rounded-[2.5rem] p-8 space-y-6 overflow-hidden relative">
              <div className="flex items-center justify-between border-b border-zinc-100 dark:border-zinc-800 pb-6">
                <div className="flex items-center gap-3">
                   ...
                   <h3 className="text-[11px] font-black uppercase tracking-[0.2em] text-slate-400 dark:text-zinc-500 italic">Messy Source</h3>
                </div>
                <Button 
                   variant="ghost" 
                   size="icon" 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                 <div className="space-y-4">
                    ...
                    <textarea
                      ...
                      placeholder="Paste text with extra spaces or tabs..."
                      value={input}
                 ...
                 <div className="space-y-4">
                    <div className="flex justify-between items-center px-2">
                       <label className="text-[10px] font-black uppercase tracking-widest text-[#c5a059]">Sanitized Output</label>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
               <Button 
                ...
                >
                  ...
                  {copied ? "COPIED TO CLIPBOARD" : "DOWNLOAD CLEAN TEXT"}
                </Button>
                <div className="flex items-center gap-4 px-8 h-20 rounded-[2rem] bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800">
                   <div className="flex flex-col">
                      <span className="text-[9px] font-black uppercase tracking-widest text-slate-400">Saving Efficiency</span>
          ...
          <div className="lg:col-span-4 space-y-6 lg:sticky lg:top-24">
            ...
            <div className="suite-card rounded-[2.5rem] p-8 space-y-8 animate-in slide-in-from-right-4 duration-500">
               <div className="space-y-1">
                  <h2 className="text-xl font-bold text-slate-900 dark:text-white tracking-tight">Purge Settings</h2>
                  <p className="text-[10px] font-bold text-slate-400 dark:text-zinc-500 uppercase tracking-widest italic">Cleaning Protocol</p>
               </div>

               <div className="space-y-3">
                  {[
                    { key: "multiSpace", label: "Collapse Multi-Spaces", desc: "Turn '   ' into ' '" },
                    { key: "tabs", label: "Convert Tabs", desc: "Replace tabs with spaces" },
                    { key: "emptyLines", label: "Remove Empty Lines", desc: "Strip out blank lines" },
                    { key: "trimLines", label: "Trim All Lines", desc: "Remove leading/trailing space" },
                    { key: "lineBreaks", label: "Remove All Breaks", desc: "Convert text to single line" },
                  ].map((item) => (
                    <button
                      key={item.key}
            ...
            <div className="suite-card p-8 rounded-[2.5rem] bg-[#c5a059]/5 border border-[#c5a059]/10 space-y-4">
               <div className="flex items-center gap-3">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-widest text-[#c5a059]">Sanitization Shield</span>
               </div>
               <p className="text-[10px] font-medium text-slate-500 leading-relaxed uppercase tracking-wider italic">
                  Deterministic regex-based cleaning ensures 100% data integrity with zero tracking.
               </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
               <div className="suite-card p-6 rounded-3xl flex flex-col items-center text-center gap-2">
                  ...
                  <span className="text-[9px] font-black uppercase tracking-widest text-slate-400">Low Overhead</span>
               </div>
               <div className="suite-card p-6 rounded-3xl flex flex-col items-center text-center gap-2">
